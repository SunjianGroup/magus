...
class Magus:
    ...
    def Onestep(self):
        ...
        #######  get next Pop  #######
        # renew volRatio
        #volRatio = goodPop.copy()
        #volRatio.select(self.parameters.saveGood)
        #volRatio = volRatio.get_volRatio()

        #self.Generator.updatevolRatio(0.7*self.Generator.p.volRatio + 0.3*volRatio)
